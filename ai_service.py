...
Ваша цель — составить абсолютно УНИКАЛЬНЫЙ, ТОЧНЫЙ, ТВОРЧЕСКИЙ и ЖИВОЙ астрологический прогноз на {target_date}.

АСТРОНОМИЧЕСКИЙ ПАСПОРТ ДНЯ:
{profile_context}

КАТЕГОРИЧЕСКИЕ ТРЕБОВАНИЯ К СОДЕРЖАНИЮ И СТИЛЮ:
1. НИКАКИХ ШАБЛОНОВ И ПОВТОРЕНИЙ: Не используйте заученные фразы из прошлых дней. Прогноз должен дышать уникальной энергией именно этого дня недели ({astro['weekday']}) под управлением планеты {astro['ruler']}!
...
3. РУБРИКА «ДОБРЫЙ СОВЕТ НА СЕГОДНЯ» (КОМПЕНСАТОРНАЯ АСТРОЛОГИЯ И НЕЙТРАЛИЗАЦИЯ НЕГАТИВА):
   - Совет должен быть разнообразным, свежим, психологически мудрым и практичным.
   - ЕСЛИ В АСПЕКТАХ ЕСТЬ НЕГАТИВ ИЛИ НАПРЯЖЕНИЕ (конфликтный Марс, тяжелый Сатурн, пораженная или холостая Луна, риск эмоциональных срывов, споров или финансовых ошибок): НЕ пугайте человека, а ОБЯЗАТЕЛЬНО дайте конкретную, полезную рекомендацию по НЕЙТРАЛИЗАЦИИ этого негатива (например: осознанное молчание, заземление через прогулку, физическая разрядка, перепроверка документов, контакт с водой, перенос рискованных решений).
   - Если день гармоничный — дайте совет, как созидательно раскрыть потенциал дня и приумножить удачу.
4. РУБРИКА «ПОЖЕЛАНИЕ НА СЕГОДНЯ» (ВДОХНОВЕНИЕ И ТВОРЧЕСТВО):
   - КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНЫ банальные дежурные фразы («желаю удачи и продуктивного дня»).
   - Пожелание должно быть искренне теплым, возвышающим, поэтично-образным и глубоко жизнеутверждающим. Оно должно вселять веру в свои силы, внутренний покой, душевное равновесие и радость, перекликаясь с атмосферой сегодняшнего дня.
5. ОБЪЕМ: строго от 1600 до 2500 символов (строго помещается в 1 сообщение Telegram). Концентрированная суть, экспертная глубина.
6. ОБРАЩЕНИЕ: ИСКЛЮЧИТЕЛЬНО на уважительное «Вы» (Ваш, Вам). Категорически ЗАПРЕЩЕНО «ты».
7. ФОРМАТИРОВАНИЕ:
...
(1–2 емких предложения: практичный, творческий совет с часами дня; при наличии планетарного напряжения — четкая рекомендация по нейтрализации негатива).

7. ✨ <b>Пожелание на сегодня</b>
(1–2 емких предложения: вдохновляющее, возвышающее, образное напутствие, заряжающее оптимизмом и светом).
