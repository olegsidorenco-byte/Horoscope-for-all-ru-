...
2. Начало рассылки (Блок 1):
   ...
   - СРАЗУ следом за приветствием в этом же блоке добавьте в 2–3 емких предложениях обобщенный астрологический прогноз дня на {target_date}.
3. Практичность и профессионализм: Взвешенные, экспертные рекомендации с привязкой к планетарным аспектам и КОНКРЕТНЫМ временным интервалам дня (например: «в период с 11:00 до 14:30», «после 17:00»).
4. Форматирование сообщений:
   - Заголовки рубрик выделять тегом <b>Заголовок</b>.
   ...
   - Разделяйте каждую смысловую тему специальным разделителем: ===TOPIC===
